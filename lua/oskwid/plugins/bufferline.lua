...
local inactive = {
  fg = oskwid_themes.secondaryForeground,
  bg = oskwid_themes.lowBackground,
}

local M = {
  -- whole bar background
  fill = {
    bg = oskwid_themes.activeBackground,
  },
  ...
  separator = {
    fg = oskwid_themes.activeBackground,
    bg = inactive.bg,
  },
